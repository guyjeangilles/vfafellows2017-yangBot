...
function respond() {
  ...
  if(request.text && botRegexYin.test(request.text)) {
	this.res.writeHead(200);
    postMessageYin();
    this.res.end();
  } 
  
  if(request.text && botRegexPlatform.test(request.text)) {
	this.res.writeHead(200);
    postMessagePlatform();
    this.res.end();
  } 
  
  if(request.text && botRegexStartup.test(request.text)) {
	this.res.writeHead(200);
    postMessageStartup();
    this.res.end();
  }
  ...
  if(request.text && botRegexPivot.test(request.text)) {
	this.res.writeHead(200);
    postMessagePivot();
    this.res.end();
  }
...
function postMessageYin() {
  var botResponse, options, body, botReq;
  
  botResponse ='No Yin, just Yang';
...
function postMessagePlatform() {
  var botResponse, options, body, botReq;
  
  botResponse =' PLATFORM';
